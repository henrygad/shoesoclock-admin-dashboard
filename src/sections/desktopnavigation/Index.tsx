      ...
      <menu className="flex-1 flex justify-start p-4 border-r border-[#f4f0f0] ">
        <ul className="flex-1 flex flex-col gap-2 text-[#181111]">
          <li
            ...
            onClick={() => navigate("/")}
          >
            <span className="inline-block size-[24px]">
              <svg
          ...
          <li
            className="flex items-center gap-3 px-3 py-2 w-full cursor-pointer rounded-lg bg-[#f4f0f0]"
          ...
          >
            ...
            <p className="text-sm font-medium leading-normal">Discounts</p>
          </li>
          <li
            className="flex items-center gap-3 px-3 py-2 w-full cursor-pointer"
